...
+ (void) createEmailFromImageOfView:(UIView*)view matchName:(NSString*)matchName delegate:(id)delegate{
    ...
    [controller setMessageBody:[NSString stringWithFormat:@"<meta name=\"viewport\" content=\"width=%f, user-scalable=no\">Match Name: %@<br/><br/><img src=\"data:image/jpg;base64,%@\"/>\n\nGenerated by Assist Apps. www.assistapps.com.au",view.frame.size.width,matchName,base64] isHTML:YES];
...
+ (void) createEmailFromImageOfView:(UIView*)view subject:(NSString*)subject matchName:(NSString*)matchName delegate:(id)delegate{
    ...
    [controller setMessageBody:[NSString stringWithFormat:@"<meta name=\"viewport\" content=\"width=%f, user-scalable=no\">Match Name: %@<br/><br/><img style=\"max-width:100%%\" src=\"data:image/jpg;base64,%@\"/>\n\nGenerated by Assist Apps. www.assistapps.com.au",view.frame.size.width,matchName,base64] isHTML:YES];
